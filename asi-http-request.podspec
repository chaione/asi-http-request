Pod::Spec.new do |s|
  ...
  s.version  = '1.8.1'
  s.summary  = 'Easy to use CFNetwork wrapper for HTTP requests, Objective-C,
Mac OS X and iPhone.'
  s.homepage = 'http://allseeing-i.com/ASIHTTPRequest'
  s.author   = { 'Ben Copsey' => 'ben@allseeing-i.com' }
  s.source   = { :git => 'https://github.com/chaione/asi-http-request.git', :tag
=> 'v1.8.1' }
  ...
  if config.ios?
    ...
    s.source_files =
FileList['Classes/*.*'].exclude(/ASIAuthenticationDialog\.\w$/)
